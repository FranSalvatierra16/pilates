...
import { formatDate, isCuotaVencida, isCuotaVenceHoy, calcularFechaVencimiento, parseFechaLocal, horaActualInput } from '../utils/date';
          ...
          <div className="bg-white rounded-t-2xl sm:rounded-xl shadow-xl max-w-md w-full max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleSubmitPago} className="p-4 sm:p-6 space-y-4 overflow-y-auto overscroll-contain">
              ...
              <div>
                ...
                <input
                  type="time"
                  value={formDataPago.hora}
                  onChange={(e) => setFormDataPago({ ...formDataPago, hora: e.target.value })}
                  className="input-field"
                />
              </div>
              <div>
